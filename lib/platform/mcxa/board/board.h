...
#define LED_RED_INIT(output)                                           \
	gpio_pin_config_t red_led_config = {output,0};                         \
    GPIO_PinInit(BOARD_LED_RED_GPIO, BOARD_LED_RED_GPIO_PIN, &red_led_config) /*!< Enable target LED_RED */
#define LED_RED_ON() \
...
#define LED_GREEN_INIT(output)                                             \
	gpio_pin_config_t green_led_config = {output,0};                             \
    GPIO_PinInit(BOARD_LED_GREEN_GPIO, BOARD_LED_GREEN_GPIO_PIN, &green_led_config) /*!< Enable target LED_GREEN */
#define LED_GREEN_ON() \
...
#define LED_BLUE_INIT(output)                                            \
	gpio_pin_config_t blue_led_config = {output,0};                           \
	GPIO_PinInit(BOARD_LED_BLUE_GPIO, BOARD_LED_BLUE_GPIO_PIN, &blue_led_config); /*!< Enable target LED_BLUE */
#define LED_BLUE_ON() \
