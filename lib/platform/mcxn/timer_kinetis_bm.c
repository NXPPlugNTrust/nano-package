...
#define CORR_FRDM_MCXN_ARMCC (1000 / 100)
#define CORR_FRDM_MCXN_ICCARM (1000 / 108)
#define CORR_FRDM_MCXN_GCC (1000 / 100)

#if defined(__ARMCC_VERSION)
#define CORRECTION_TOLERENCE CORR_FRDM_MCXN_ARMCC
#elif defined(__ICCARM__)
#define CORRECTION_TOLERENCE CORR_FRDM_MCXN_ICCARM
#else
#define CORRECTION_TOLERENCE CORR_FRDM_MCXN_GCC
#endif
